...
<html lang="en">
   <head>
      ...
      <link rel="stylesheet" href="a/css/foundation.css" />
      <script src="a/js/vendor/jquery.js"></script>
      <script src="a/js/vendor/modernizr.js"></script>
   </head>
   <body>
      ...
      <div id="footer">
         ...
         <div class="row">
            <div class="large-6 columns" style="margin-top: -15px;">
               &copy; Fullstack challenge 2020
            </div>
         </div>
      </div>
      </div>
      <script src="a/js/foundation.min.js"></script>
      <script src="a/js/sticky-footer.js"></script>
      <script src="a/js/foundation/foundation.topbar.js"></script>
      <script src="a/js/foundation/foundation.reveal.js"></script>
      <script src="a/js/foundation/foundation.abide.js"></script>
      <script>
         $(document).foundation();
      </script>
   </body>
